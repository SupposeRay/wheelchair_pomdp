/*
 * DvcWheelchairPomdpSmartScenarioLowerBoundPolicy.h
 *
 *  Created on: 15 Dec, 2021
 *      Author: neha
 */

#ifndef DVCWHEELCHAIRPOMDPSMARTSCENARIOLOWERBOUNDPOLICY_H_
#define DVCWHEELCHAIRPOMDPSMARTSCENARIOLOWERBOUNDPOLICY_H_
...
//Not changing names of the lower bounds to avoid changing names everywhere
...
public:
 ...
 public:
 	DEVICE static Dvc_ValuedAction Value(int scenarioID, Dvc_State * particles)
 	{
		 ...
		 //Action hard coded for WheelchairDSPOMDP::LINEAR_MINUS
		 //return(Dvc_ValuedAction(1, -1));
